...
// Empaquetado móvil de Pensamiento Libre.
//
...
//
// El destino es el despliegue en Coolify: https://pensamiento-libre.org
...
const APP_URL = process.env.APP_URL || 'https://pensamiento-libre.org';

const config: CapacitorConfig = {
  appId: 'ec.fpl.pensamiento',
  appName: 'Pensamiento Libre',
  webDir: 'www',
  ...
  plugins: {
    StatusBar: { style: 'DARK', backgroundColor: '#12263f' },
  },
};
