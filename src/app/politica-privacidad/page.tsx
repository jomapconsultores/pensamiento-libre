      ...
      <div className="space-y-8 text-brand-navy/85 leading-relaxed">
        ...
        <LegalSection title="5. Tus derechos">
          ...
          <ul className="list-disc pl-6 space-y-2 mt-2">
            ...
            <li>Cancelar tu suscripción al newsletter escribiéndonos a jomapconsultores@gmail.com.</li>
        ...
        <LegalSection title="7. Cookies">
          <p>
            No utilizamos cookies de publicidad ni de seguimiento entre sitios. El panel de
            administración se protege con autenticación HTTP (usuario y contraseña), sin cookies de
            sesión. Si en el futuro incorporamos cookies de medición u otro tipo, actualizaremos
            esta sección antes de hacerlo.
          </p>
        </LegalSection>
